    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <?php if(Session::has('success_msg')) { ?>
                <div class="alert alert-block alert-success fade in" style="margin:10px auto; width:97%;">
                                    ...
                                    <form role="form" id="form-validation" action="" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="col-md-6">
                                                <div>
                                                    <label for="img-upload" class="pointer">
                                                        @if($admins->avater != '')
                                                            <img id="uploadPreview" src="{{asset('public/users/'.$admins->avater)}}" width="118" alt="">
                                                        @else
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Email</label>
                                                    <input type="text" class="form-control" name="admin_email" id="admin_email" value="{{$admins->admin_email}}" placeholder="Email" required >
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control" name="admin_password" id="admin_password" value="{{$password}}" placeholder="Password">
                                                </div>
                                            </div>
